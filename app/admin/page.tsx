...
export default function AdminDashboard() {
  return (
    <AdminLayout activeModule="overview">
      <div className="space-y-6">
        {/* Welcome section */}
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-3xl font-bold text-foreground text-balance">Admin Dashboard</h2>
            <p className="text-muted-foreground mt-2">Banking operations control center</p>
          </div>
